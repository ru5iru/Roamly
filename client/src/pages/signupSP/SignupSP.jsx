    ...
    <section class="sptext-center">
      <div className="spcontainer">
        <div className="spcontainer-body">
            ...
            <div className="spcard">
              <div className="spcard-body">
                ...
                <form>
                  <div className="sprow ">
                    <div class="spcol">
                      <div class="spform-outline-11">
                        <input
                          type="text"
                          id="form3Example1"
                          class="spform-control"
          ...
          <div class="spcontainer-img">
            <img src={img2} class="spimg" alt="" />
          </div>
        </div>
      </div>
    </section>
