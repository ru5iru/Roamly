...
const Navbar = () => {
    ...
    return (
        <div className="navbar">
            <div className="left">
                <img src={logo} alt="" className="logo navimg" onClick={navigateFeed} />
            </div>
            <div className="right">
                {/* < Search_component /> */}
                    ...
                    <form className="search" id="search-bar">
                        <div className="display-flex-row height-100 align-items-center padding-left-3">
                            <input
                                ...
                                id="searchId"
                            />
                            <img src={Search_blue} type="submit" className="search-button-b navimg" onClick={handleSearch} />
                        </div>
                        <img
                            src={Search}
                ...
                <img src={currentUser.profile_pic} alt="" className="usr_pic navimg" onClick={() => setUserMenuOpen(!userMenuOpen)} />
                {userMenuOpen && (
